                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset($article->image) }}" class="avatar avatar-sm me-3" alt="user1">
                                            </div>
                                    ...
                                    <td class="align-middle text-center text-sm" article-id="{{$article->id}}">
                                        {!!$article->status==0 ? "<span class='badge badge-sm bg-gradient-success' type='checkbox' checked>Aktif</span>"
                                        :"<span class='badge badge-sm bg-gradient-secondary' type='checkbox' checked>Pasif</span>"!!}
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                ...
                                                <a class="btn btn-link text-danger text-gradient px-3 mb-0" title="Sil" href="{{route('admin.delete.article',$article->id)}}"><i class="far fa-trash-alt me-2"></i></a>
                                                <a class="btn btn-link text-dark px-3 mb-0" title="Düzenle" href="{{route('admin.bloglar.edit',$article->id)}}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i></a>
                                                <a class="btn btn-link text-bg-primary px-3 mb-0" title="Görüntüle"  target="_blank" href="{{{route('single',[$article->getCategory->slug,$article->slug])}}}" ><i class="far fa-solid fa-eye"></i></a>
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
